...
1. Which layer is actually decentralized: data, models, compute, or governance?  
2. What exactly is the blockchain responsible for?  
3. Is the efficiency tradeoff worth the openness gained?  
4. What concrete advantage exists over a centralized alternative?  
