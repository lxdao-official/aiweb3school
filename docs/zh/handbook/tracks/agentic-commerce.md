...
::: info 相关 topic
- [机器支付](/zh/handbook/bridge/machine-payment/)：理解 Agent 如何为 API、数据和推理服务付款。
- [x402](https://www.x402.org/)：了解基于 HTTP 402 的机器支付协议设计。
:::
...
::: info 相关 topic
- [结算与托管](/zh/handbook/bridge/settlement-and-escrow/)：任务完成、验收、退款和争议处理的状态机。
- [ERC-8183](https://eips.ethereum.org/EIPS/eip-8183)：了解 Agent 任务与支付结算相关的标准化尝试。
:::
...
- [x402 Protocol](https://www.x402.org/)：学习基于 HTTP 402 的机器支付流程。
- [Coinbase x402 Docs](https://docs.cdp.coinbase.com/x402/)：看实际开发者如何接入 x402。
- [Machine Payment Protocol](https://mpp.dev/)：理解 Agent 支付、服务发现和结算的协议化尝试。
- [Agent Payments Protocol](https://ap2-protocol.org/)：了解 Agent 支付授权、意图和商业交互的协议设计。
- [ERC-8183](https://eips.ethereum.org/EIPS/eip-8183)：阅读 Agent 任务支付和托管相关的 EIP。
