...
- [AI 基本概念](./docs/en/part1/ai-fundamentals.md)
- [机器学习基础](./docs/en/part1/machine-learning-basics.md)
- [深度学习入门](./docs/en/part1/deep-learning-intro.md)
- [AI 工具与平台](./docs/en/part1/ai-tools.md)

### 第二部分：Web3 基础

- [区块链基础](./docs/en/part2/blockchain-basics.md)
- [DeFi 入门](./docs/en/part2/defi-intro.md)
- [智能合约](./docs/en/part2/smart-contracts.md)
- [Web3 工具](./docs/en/part2/web3-tools.md)

### 第三部分：AI x Web3 方向

- [AI 代理](./docs/en/part3/ai-agents.md)
- [AI + DeFi](./docs/en/part3/ai-defi.md)
- [AI + NFT](./docs/en/part3/ai-nft.md)
- [去中心化 AI](./docs/en/part3/decentralized-ai.md)

### 第四部分：案例与实践

- [案例研究](./docs/en/part4/case-studies.md)
- [项目指南](./docs/en/part4/project-guide.md)
- [资源汇总](./docs/en/part4/resources.md)
